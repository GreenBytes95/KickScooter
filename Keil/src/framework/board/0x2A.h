...
/* Идентификация платы */
# define CONFIG_BOARD_TYPE                                              0x2A
/* Количество попугаев на 1 Вольт * */
# define CONFIG_BOARD_BIT_VBAT                                          43
/* Количество попугаев на 1 Ампер ** */
# define CONFIG_BOARD_BIT_CURRENT                                       46

/* Использование UART */
# define UART0_ENA
# define UART1_ENA

/* Использовать для управления кнопку включения как ADC */
# define POWER_BUTTON_ADC
